...
export default function OrderManagement({ tables, setTables, dishes, customers, setCustomers }: OrderManagementProps) {
          ...
          <DialogContent className="max-w-3xl">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select onValueChange={(value) => setSelectedDishes([...selectedDishes, dishes.find(d => d.dishID === value)!])}>
                  <SelectTrigger className="col-span-3">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select onValueChange={(value) => setEditingCustomer({
                  ...editingCustomer,
                  dishes: [...editingCustomer.dishes, dishes.find(d => d.dishID === value)!]
                })}>
                  <SelectTrigger className="col-span-3">
                    <SelectValue placeholder="Add dish" />
                  </SelectTrigger>
