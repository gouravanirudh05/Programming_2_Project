...
public abstract class BillStore {
    ...
    public abstract void addBill(ArrayList<String> a, ArrayList<Float> b, ArrayList<Integer> c, DateTime payed);
    public abstract void removeBill(int billId);
    public abstract void updateBill(int billId, ArrayList<String> purchased, ArrayList<Float> purchasedList, ArrayList<Integer> quantity, DateTime payedOn);
